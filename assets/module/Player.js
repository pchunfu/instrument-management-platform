layui.define(function(exports) {
  ...
  var Player = function(e) {
    ...
    var h = function(e) {
      ...
      return function(e, t) {
        ...
        value: function() {
          ...
          var e = player.root.offsetWidth,
            t = player.root.offsetHeight,
    ...
    ((r = a) && r.__esModule ? r : {
      default: r
    }).default.install("localPreview", function() {
      var e = this,
        t = e.root;
    ...
    i.default.install("s_progress", function() {
      ...
      var a = n.querySelector(".xgplayer-progress-played"),
        o = n.querySelector(".xgplayer-progress-btn"),
        ...
        n.addEventListener(i, function(i) {
          ...
          var l = a.getBoundingClientRect().left,
            s = function(n) {
              ...
              var i = n.clientX - l > r ? r : n.clientX - l,
                s = i / r * e.duration;
            ...
            c = function i(u) {
              if (u.preventDefault(), u.stopPropagation(), t.event(u), window.removeEventListener("mousemove", s), window.removeEventListener("touchmove", s, {
                  passive: !1
          ...
          return window.addEventListener("mousemove", s), window.addEventListener("touchmove", s, {
            passive: !1
          }), window.addEventListener("mouseup", c), window.addEventListener("touchend", c), !1
        })
      }), n.addEventListener("mouseenter", function(r) {
        if (!e.config.allowSeekAfterEnded && e.ended) return !1;
        var a = n.getBoundingClientRect().left,
          ...
          o = function(r) {
            ...
            if (e.config.thumbnail) {
              ...
              var p = s + 1 - y * x * (Math.ceil((s + 1) / (y * x)) - 1),
                d = Math.ceil(p / x) - 1,
                b = p - d * x - 1;
      ...
      var b = !1,
        k = function() {
          if (!r && n && (r = n.getBoundingClientRect().width), "audio" !== e.videoConfig.mediaType || !e.isProgressMoving || !e.dash) {
            ...
            if (t < 0) o.style.left = "0px", o.style.transform = "", b = !1;
            else if (t + 14 > r) o.style.left = r - 14 + "px", o.style.transform = "", b = !1;
            else {
              if (b) return;
    ...
    i.default.install("s_playbackRate", function() {
      ...
      var n = t.createDom("xg-playbackrate", " ", {}, "xgplayer-playbackrate"),
        r = [];
